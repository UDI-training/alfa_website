...
<body>
    ...
    <div class="first-container">
        ...
        <div id="bloc">
            <h1 class="titulos-g">4C</h1>
            <h2 id="texto-s">Centro de Capacitación Certificado en Conducción</h2>
            <div id="myButtonContainer">
                <button id="myButton">Quiero certificarme</button>
            </div>
        </div>
    </div>
    <div class="blueBloc">
        <div style="display: block; height: 0;"></div>
        <div id="titulo-G2">Q&nbsp;U&nbsp;I&nbsp;E&nbsp;N&nbsp;E&nbsp;S&nbsp; &nbsp;S&nbsp;O&nbsp;M&nbsp;O&nbsp;S</div>
        <div id="texto-XS">Somos un grupo de profesionales en la cultura vial con 30 años de experiencia, que preocupados ante la alarmante incidencia de accidentes vehiculares por la falta de capacitación se unieron, para crear un Centro de Capacitación en Conducción con la finalidad de educar a las próximas generaciones de conductores, para que se protejan así mismos, a su familia y al resto de las personas que utilizan las vías públicas.</div>
    </div>
